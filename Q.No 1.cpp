...
void list::insert_begin(int value)
{
    ...
    //cout<<"Insert the starting element"<<endl;
}
...
void list::insertatend(int value)
{
    ...
    temp->next = NULL;
    s->next = temp;
   // cout<<"ELEMENT INSERTED AT THE LAST IS"<<endl;  
}
